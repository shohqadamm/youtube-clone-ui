            ...
            <v-col cols="12" sm="12" md="8" lg="8">
              ...
              >
                <v-responsive>
                  ...
                  <iframe width="100%" height="720" :src="`https://www.youtube.com/embed/${this.$route.params.id}`" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </v-responsive>
