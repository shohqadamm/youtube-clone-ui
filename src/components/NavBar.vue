        ...
        <v-card>
          <v-list>
            <v-list-item>
              ...
              <v-list-item-content>
                <v-list-item-title>Shohqadam Ergashev</v-list-item-title>
                <v-list-item-subtitle
                  >ergashevshohqadam@gmail.com</v-list-item-subtitle
                >
              </v-list-item-content>
            </v-list-item>
          </v-list>
...
export default {
  ...
  methods: {
    search() {
      ...
      // axios
      // .get(
      //   `https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=${this.searchText}&maxResults=10&key=AIzaSyDeQSkZ24yzT1Fi_ecPzlw2CzxVwVw4A_U`
      // )
